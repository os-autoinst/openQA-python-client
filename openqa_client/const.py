...
JOB_STATES =               (JOB_STATE_SCHEDULED, JOB_STATE_SETUP, JOB_STATE_RUNNING,
                            JOB_STATE_CANCELLED, JOB_STATE_WAITING, JOB_STATE_DONE,
                            JOB_STATE_UPLOADING, JOB_STATE_ASSIGNED)
JOB_PENDING_STATES =       (JOB_STATE_SCHEDULED, JOB_STATE_ASSIGNED, JOB_STATE_SETUP,
                            JOB_STATE_RUNNING, JOB_STATE_WAITING, JOB_STATE_UPLOADING)
JOB_EXECUTION_STATES =     (JOB_STATE_ASSIGNED, JOB_STATE_SETUP, JOB_STATE_WAITING,
