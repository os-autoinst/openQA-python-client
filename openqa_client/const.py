...
JOB_STATES =           [JOB_STATE_SCHEDULED, JOB_STATE_RUNNING, JOB_STATE_CANCELLED,
                        JOB_STATE_WAITING, JOB_STATE_DONE]
...
JOB_RESULTS =            [JOB_RESULT_NONE, JOB_RESULT_PASSED, JOB_RESULT_FAILED,
                          JOB_RESULT_INCOMPLETE, JOB_RESULT_SKIPPED, JOB_RESULT_OBSOLETED,
                          JOB_RESULT_PARALLEL_FAILED, JOB_RESULT_PARALLEL_RESTARTED,
                          JOB_RESULT_USER_CANCELLED, JOB_RESULT_USER_RESTARTED]
JOB_COMPLETE_RESULTS =   [JOB_RESULT_PASSED, JOB_RESULT_FAILED]
